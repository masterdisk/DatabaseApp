...
declare function exportFromJSON<R = void>({ data, fileName, fileNameFormatter, fields, exportType, replacer, space, processor, withBOM, delimiter, beforeTableEncode }: IOption<R>): R;
